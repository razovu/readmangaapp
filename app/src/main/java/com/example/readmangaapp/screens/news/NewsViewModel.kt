...
class NewsViewModel @Inject constructor(private val repository: NewsRepository): ViewModel(){
    ...
    private val _newsList: MutableLiveData<MutableList<ReadMangaNewsEntity>> = MutableLiveData(mutableListOf())
    val newsList: LiveData<MutableList<ReadMangaNewsEntity>> = _newsList
    ...
    fun updateCatalogList() {
        ...
        viewModelScope.launch(Dispatchers.Default) {
            ...
            _newsList.postValue((_newsList.value?.plus(list)) as MutableList<ReadMangaNewsEntity>?)
        }
